<template>
  <div class="">
      <MainLayout>
          <template #main>
            <section class="mb-8">
          <h2 class="px-4 py-4 mb-4 text-3xl font-bold text-white bg-sky-900">Beneficios de Elegir Foredom con Nosotros</h2>
      </section>

      <section class="px-4 mb-8">
          <h3 class="mb-4 text-2xl font-bold text-sky-800">¿Por qué elegirnos?</h3>
          <div class="grid gap-4 md:grid-cols-2">
              <div class="p-4 bg-white rounded shadow">
                  <h4 class="mb-2 text-xl font-bold text-sky-900">Precios Competitivos</h4>
                  <p>Importamos productos Foredom de Estados Unidos y Asia, ofreciéndote las opciones más asequibles sin sacrificar calidad. Sabemos que cada cliente tiene sus preferencias, por lo que ofrecemos una variedad de modelos para satisfacer todos los gustos.</p>
              </div>
              <div class="p-4 bg-white rounded shadow">
                  <h4 class="mb-2 text-xl font-bold text-sky-900">Importación Directa</h4>
                  <p>Al importar directamente, podemos ofrecerte precios mucho más bajos que los de distribuidores tradicionales, manteniendo siempre productos originales y con la garantía de calidad que solo Foredom puede ofrecer.</p>
              </div>
              <div class="p-4 bg-white rounded shadow">
                  <h4 class="mb-2 text-xl font-bold text-sky-900">Variedad de Productos</h4>
                  <p>Desde motores hasta refacciones, tenemos todo lo que necesitas para tu equipo Foredom. Todos nuestros productos, ya sean de Foredom USA o Foredom Asia, cuentan con la misma fiabilidad y rendimiento, pero con la opción de elegir según tus preferencias de costo.</p>
              </div>
              <div class="p-4 bg-white rounded shadow">
                  <h4 class="mb-2 text-xl font-bold text-sky-900">Refacciones Originales</h4>
                  <p>Además de motores y herramientas, también ofrecemos una amplia gama de refacciones Foredom para asegurar que tu equipo siempre esté en óptimas condiciones. Si eres distribuidor, también tenemos precios especiales para ti.</p>
              </div>
          </div>
      </section>

      <section class="px-4 mb-8">
          <h3 class="mb-4 text-2xl font-bold text-sky-800">¿Qué Diferencia a Foredom USA y Foredom Asia?</h3>
          <div class="grid gap-4 md:grid-cols-2">
              <div class="flex items-center p-4 bg-white rounded shadow">
                  <i class="mr-4 text-3xl text-blue-600 fas fa-flag-usa"></i>
                  <div>
                      <h4 class="mb-2 text-xl font-bold text-sky-900">Foredom USA</h4>
                      <p>Fabricados en Estados Unidos con precios más altos debido a su fabricación en USA. Alta demanda por su prestigio y calidad. Ideal para quienes buscan productos con prestigio internacional.</p>
                  </div>
              </div>
              <div class="flex items-center p-4 bg-white rounded shadow">
                  <i class="mr-4 text-3xl text-blue-600 fas fa-globe-asia"></i>
                  <div>
                      <h4 class="mb-2 text-xl font-bold text-sky-900">Foredom Asia</h4>
                      <p>Fabricados en Asia con precios más competitivos sin sacrificar la calidad. Ofrecen la misma calidad y funciones, pero a precios más bajos. Perfectos para quienes buscan opciones de calidad a menor costo.</p>
                  </div>
              </div>
          </div>
      </section>
      ...
      <section class="px-4 mb-8">
          <h3 class="mb-4 text-2xl font-bold text-sky-800">¿Por Qué Elegir Foredom con Nosotros?</h3>
          <div class="grid gap-4 md:grid-cols-2 lg:grid-cols-4">
              <div class="flex items-center p-4 bg-white rounded shadow">
                  <i class="mr-4 text-3xl text-blue-600 fas fa-award"></i>
                  <div>
                      <h4 class="mb-2 text-xl font-bold text-sky-900">Más de 30 años de experiencia</h4>
                      <p>Contamos con una vasta experiencia en el sector, garantizando productos y servicios de alta calidad.</p>
                  </div>
              </div>
              <div class="flex items-center p-4 bg-white rounded shadow">
                  <i class="mr-4 text-3xl text-blue-600 fas fa-dollar-sign"></i>
                  <div>
                      <h4 class="mb-2 text-xl font-bold text-sky-900">Precios más bajos del mercado</h4>
                      <p>Ofrecemos productos originales y de calidad a los precios más competitivos del mercado.</p>
                  </div>
              </div>
              <div class="flex items-center p-4 bg-white rounded shadow">
                  <i class="mr-4 text-3xl text-blue-600 fas fa-shipping-fast"></i>
                  <div>
                      <h4 class="mb-2 text-xl font-bold text-sky-900">Importación mayorista directa</h4>
                      <p>Importamos directamente para ofrecerte los mejores costos y productos originales.</p>
                  </div>
              </div>
              <div class="flex items-center p-4 bg-white rounded shadow">
                  <i class="mr-4 text-3xl text-blue-600 fas fa-th-large"></i>
                  <div>
                      <h4 class="mb-2 text-xl font-bold text-sky-900">Variedad en modelos</h4>
                      <p>Tenemos una amplia gama de modelos para ajustarse a tus necesidades y presupuesto.</p>
                  </div>
              </div>
          </div>
      </section>
      ...
      <div class="py-10" id="refacciones"></div>
      <section >
...
onMounted(() => {
  const refaccionesSection = document.getElementById('refacciones');
  if (refaccionesSection) {

    refaccionesSection.scrollIntoView({ behavior: 'smooth' });
  }
});
</script>
