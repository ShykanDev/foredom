              ...
              <div>
                ...
                <div class="relative mt-1 rounded-md shadow-sm">
                  ...
                  <textarea id="message" name="message" rows="4" v-model="message" :class="{'border-red-500': noMessage}" required
                    class="block w-full py-2 pl-10 pr-3 border rounded-md border-sky-800 focus:outline-none focus:ring-indigo-500 focus:border-indigo-500 sm:text-sm" placeholder="Escriba su mensaje"></textarea>
                </div>
